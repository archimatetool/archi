...
public class ImageExportProviderTests {
    ...
    public void testSavePreferences() {
        ...
        assertEquals(345, ArchiPlugin.INSTANCE.getPreferenceStore().getInt(ImageExportProvider.PREFS_IMAGE_SCALE));
    }
    
    @Test
    public void testPreferencesWereLoaded() {
        ArchiPlugin.INSTANCE.getPreferenceStore().setValue(ImageExportProvider.PREFS_IMAGE_SCALE, 123);
