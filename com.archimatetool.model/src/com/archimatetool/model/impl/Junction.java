 ...
 * </p>
 * <ul>
 *   <li>{@link com.archimatetool.model.impl.Junction#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Junction extends ArchimateElement implements IJunction {
    ...
    public void setType(String newType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, IArchimatePackage.JUNCTION__TYPE, oldType, type));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case IArchimatePackage.JUNCTION__TYPE:
                return getType();
        }
