...
public class ArchimatePackage extends EPackageImpl implements IArchimatePackage {
    ...
    public void initializePackageContents() {
        ...
        diagramModelConnectionEClass.getESuperTypes().add(this.getTextAlignment());
        ...
        addEParameter(op, ecorePackage.getEJavaObject(), "key", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
