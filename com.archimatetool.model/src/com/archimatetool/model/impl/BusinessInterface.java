...
public class BusinessInterface extends ArchimateElement implements IBusinessInterface {
    ...
    public void setInterfaceType(int newInterfaceType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, IArchimatePackage.BUSINESS_INTERFACE__INTERFACE_TYPE, oldInterfaceType, interfaceType));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case IArchimatePackage.BUSINESS_INTERFACE__INTERFACE_TYPE:
