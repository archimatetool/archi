...
public class PrintDiagramAction extends WorkbenchPartAction {
    ...
    protected boolean calculateEnabled() {
        /*
         * On Linux we get the dreaded "Prevented recursive attempt to activate part uk.ac.bolton.archimate.editor.treeModelView
         * while still in the middle of activating part uk.ac.bolton.archimate.editor.diagramEditor" if we open a diagram editor
