...
public abstract class AbstractTextControlContainerFigure extends AbstractContainerFigure implements ITextFigure {
     ...
     * @param rect the working area of the figure to calculate from 
     * @return The area to draw the figure
     */
    protected Rectangle getFigurePositionFromTextPosition(Rectangle rect) {
    	return getFigurePositionFromTextPosition(rect, 1);
    }
     ...
     * @return The area to draw the figure
     */
    protected Rectangle getFigurePositionFromTextPosition(Rectangle rect, double ratio) {
        ...
        Rectangle newPosition = rect.getCopy();
