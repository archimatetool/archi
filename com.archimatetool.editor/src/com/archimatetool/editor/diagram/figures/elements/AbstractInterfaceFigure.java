 ...
 */
public abstract class AbstractInterfaceFigure extends AbstractArchimateFigure {
    
    protected IFigureDelegate fRectangleDelegate, fEllipseDelegate;
    
    public AbstractInterfaceFigure(IDiagramModelArchimateObject diagramModelObject) {
