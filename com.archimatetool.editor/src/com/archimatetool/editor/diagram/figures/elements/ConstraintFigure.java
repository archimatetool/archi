...
public class ConstraintFigure extends AbstractMotivationFigure {
    ...
    private static IIconDelegate iconDelegate = new IIconDelegate() {
        ...
        public Rectangle getBounds() {
            // Mirrors the polygon's points array above (with pt = (0, 0)); the diagonal line sits entirely
            // inside the polygon's own bounds, but its extent is unioned in too rather than assumed
            int[] points = new int[] { 0, 0, 12, 0, 8, 9, -4, 9 };
            Rectangle bounds = new PointList(points).getBounds();
