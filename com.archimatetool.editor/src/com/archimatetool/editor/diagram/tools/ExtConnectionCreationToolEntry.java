...
public class ExtConnectionCreationToolEntry extends ConnectionCreationToolEntry {
    ...
    private static Cursor cursorAdd = new Cursor(null,
            zoom -> IArchiImages.ImageFactory.getImageDescriptor(IArchiImages.CURSOR_IMG_ADD_CONNECTION).getImageData(zoom),
            0, 0);

    private static Cursor cursorAddNot = new Cursor(null,
            zoom -> IArchiImages.ImageFactory.getImageDescriptor(IArchiImages.CURSOR_IMG_ADD_NOT_CONNECTION).getImageData(zoom),
            0, 0);
