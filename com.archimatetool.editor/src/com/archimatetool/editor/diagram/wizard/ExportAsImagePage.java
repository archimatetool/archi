...
public class ExportAsImagePage extends WizardPage {
    ...
    public void createControl(Composite parent) {
        ...
        // Get last folder
        String lastFolder = ArchiPlugin.INSTANCE.getPreferenceStore().getString(PREFS_LAST_FOLDER);
        ...
        if(!fImageProviders.isEmpty()) {
            String selectedProviderID = ArchiPlugin.INSTANCE.getPreferenceStore().getString(PREFS_LAST_PROVIDER);
    ...
    void storePreferences() {
        ...
        if(fSelectedProvider != null) {
            ArchiPlugin.INSTANCE.getPreferenceStore().setValue(PREFS_LAST_PROVIDER, fSelectedProvider.getID());
        }
    }
