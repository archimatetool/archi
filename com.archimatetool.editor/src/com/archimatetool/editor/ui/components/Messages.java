...
public class Messages extends NLS {
    ...
    private static final String BUNDLE_NAME = "com.archimatetool.editor.ui.components.messages"; //$NON-NLS-1$
    ...
    public static String StyledTextControl_2;

    public static String StyledTextControl_3;

    public static String StyledTextControl_4;
    static {
