...
public class StakeholderUIProvider extends AbstractArchimateElementUIProvider {
    ...
    public Image getImage() {
        return IArchiImages.ImageFactory.getImage(IArchiImages.ICON_STAKEHOLDER);
    }

    @Override
    public ImageDescriptor getImageDescriptor() {
        return IArchiImages.ImageFactory.getImageDescriptor(IArchiImages.ICON_STAKEHOLDER);
    }
    ...
    public IIconDelegate getIconDelegate() {
        return StakeholderFigure.getIconDelegate();
    }
}
