...
import com.archimatetool.editor.diagram.editparts.elements.ApplicationServiceEditPart;
...
public class ApplicationServiceUIProvider extends AbstractArchimateElementUIProvider {
    ...
    public Image getImage() {
        return getImageWithUserFillColor(IArchiImages.ICON_APPLICATION_SERVICE_16);
    }

    @Override
    public ImageDescriptor getImageDescriptor() {
        return getImageDescriptorWithUserFillColor(IArchiImages.ICON_APPLICATION_SERVICE_16);
    }
