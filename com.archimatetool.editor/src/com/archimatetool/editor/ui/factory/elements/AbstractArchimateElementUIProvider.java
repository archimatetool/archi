...
implements IArchimateElementUIProvider, IIconDelegateProvider {
    ...
    public int getDefaultTextAlignment() {
        return ArchiPlugin.getInstance().getPreferenceStore().getInt(IPreferenceConstants.DEFAULT_ARCHIMATE_FIGURE_TEXT_ALIGNMENT);
    }
    
    @Override
    public int getDefaultTextPosition() {
        return ArchiPlugin.getInstance().getPreferenceStore().getInt(IPreferenceConstants.DEFAULT_ARCHIMATE_FIGURE_TEXT_POSITION);
    }
    ...
    protected static Dimension getDefaultUserPreferenceSize() {
        return new Dimension(ArchiPlugin.getInstance().getPreferenceStore().getInt(IPreferenceConstants.DEFAULT_ARCHIMATE_FIGURE_WIDTH),
                             ArchiPlugin.getInstance().getPreferenceStore().getInt(IPreferenceConstants.DEFAULT_ARCHIMATE_FIGURE_HEIGHT));
    }
