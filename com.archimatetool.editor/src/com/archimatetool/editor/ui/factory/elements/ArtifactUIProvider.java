...
public class ArtifactUIProvider extends AbstractArchimateElementUIProvider {
    ...
    public Image getImage() {
        return IArchiImages.ImageFactory.getImage(IArchiImages.ICON_ARTIFACT);
    }

    @Override
    public ImageDescriptor getImageDescriptor() {
        return IArchiImages.ImageFactory.getImageDescriptor(IArchiImages.ICON_ARTIFACT);
    }
    ...
    public IIconDelegate getIconDelegate() {
        return ArtifactFigure.getIconDelegate();
    }
}
