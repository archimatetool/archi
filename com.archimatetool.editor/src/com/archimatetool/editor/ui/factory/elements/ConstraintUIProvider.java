...
public class ConstraintUIProvider extends AbstractArchimateElementUIProvider {
    ...
    public Image getImage() {
        return IArchiImages.ImageFactory.getImage(IArchiImages.ICON_CONSTRAINT);
    }

    @Override
    public ImageDescriptor getImageDescriptor() {
        return IArchiImages.ImageFactory.getImageDescriptor(IArchiImages.ICON_CONSTRAINT);
    }
    ...
    public IIconDelegate getIconDelegate() {
        return ConstraintFigure.getIconDelegate();
    }
}
