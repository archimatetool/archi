...
import com.archimatetool.editor.diagram.editparts.elements.ConstraintEditPart;
...
public class ConstraintUIProvider extends AbstractArchimateElementUIProvider {
    ...
    public Image getImage() {
        return getImageWithUserFillColor(IArchimateImages.ICON_CONSTRAINT_16);
    }

    @Override
    public ImageDescriptor getImageDescriptor() {
        return getImageDescriptorWithUserFillColor(IArchimateImages.ICON_CONSTRAINT_16);
    }
