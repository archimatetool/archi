...
import com.archimatetool.editor.diagram.editparts.elements.DeliverableEditPart;
...
public class DeliverableUIProvider extends AbstractArchimateElementUIProvider {
    ...
    public Image getImage() {
        return getImageWithUserFillColor(IArchimateImages.ICON_DELIVERABLE_16);
    }

    @Override
    public ImageDescriptor getImageDescriptor() {
        return getImageDescriptorWithUserFillColor(IArchimateImages.ICON_DELIVERABLE_16);
    }
