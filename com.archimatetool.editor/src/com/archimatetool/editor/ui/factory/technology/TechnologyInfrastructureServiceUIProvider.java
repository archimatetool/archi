...
import com.archimatetool.editor.diagram.editparts.technology.TechnologyInfrastructureServiceEditPart;
...
public class TechnologyInfrastructureServiceUIProvider extends AbstractTechnologyUIProvider {
    ...
    public Image getImage() {
        return getImageWithUserFillColor(IArchimateImages.ICON_TECHNOLOGY_INFRASTRUCTURE_SERVICE_16);
    }

    @Override
    public ImageDescriptor getImageDescriptor() {
        return getImageDescriptorWithUserFillColor(IArchimateImages.ICON_TECHNOLOGY_INFRASTRUCTURE_SERVICE_16);
    }
}
