...
import com.archimatetool.editor.diagram.editparts.business.BusinessProductEditPart;
...
public class BusinessProductUIProvider extends AbstractBusinessUIProvider {
    ...
    public Image getImage() {
        return getImageWithUserFillColor(IArchimateImages.ICON_BUSINESS_PRODUCT_16);
    }

    @Override
    public ImageDescriptor getImageDescriptor() {
        return getImageDescriptorWithUserFillColor(IArchimateImages.ICON_BUSINESS_PRODUCT_16);
    }
}
