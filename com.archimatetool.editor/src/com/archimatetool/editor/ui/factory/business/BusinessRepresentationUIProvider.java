...
import com.archimatetool.editor.diagram.editparts.business.BusinessRepresentationEditPart;
...
public class BusinessRepresentationUIProvider extends AbstractBusinessUIProvider {
    ...
    public Image getImage() {
        return getImageWithUserFillColor(IArchimateImages.ICON_BUSINESS_REPRESENTATION_16);
    }

    @Override
    public ImageDescriptor getImageDescriptor() {
        return getImageDescriptorWithUserFillColor(IArchimateImages.ICON_BUSINESS_REPRESENTATION_16);
    }
}
