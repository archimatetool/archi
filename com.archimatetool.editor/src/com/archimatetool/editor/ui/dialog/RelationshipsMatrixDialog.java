...
public class RelationshipsMatrixDialog extends ExtendedTitleAreaDialog {
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        GridDataFactory.create(GridData.FILL_BOTH).applyTo(viewer.getGrid());
        ...
        GridDataFactory.create(SWT.NONE).align(SWT.LEFT, SWT.TOP).applyTo(label);
        ...
        for(EClass eClass : getData()) {
            ...
            // Centre vertically
            column.getCellRenderer().setVerticalAlignment(SWT.CENTER);
        ...
        // ColumnSelector to handle selecting columns when clicking on header
        ColumnSelector.install(grid);
    ...
    private List<EClass> getData() {
        if(allClasses == null) {
            ...
            Collections.addAll(allClasses, ArchimateModelUtils.getAllArchimateClasses());
            Collections.addAll(allClasses, ArchimateModelUtils.getConnectorClasses());
