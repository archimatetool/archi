...
import uk.ac.bolton.archimate.editor.diagram.editparts.extensions.DriverEditPart;
...
public class DriverUIProvider extends AbstractElementUIProvider {
    ...
    public Image getImage() {
        return IArchimateImages.ImageFactory.getImage(IArchimateImages.ICON_DRIVER_FILLED_16);
    }

    @Override
    public ImageDescriptor getImageDescriptor() {
        return IArchimateImages.ImageFactory.getImageDescriptor(IArchimateImages.ICON_DRIVER_FILLED_16);
    }
