...
import uk.ac.bolton.archimate.editor.diagram.editparts.extensions.AssessmentEditPart;
...
public class AssessmentUIProvider extends AbstractElementUIProvider {
    ...
    public Image getImage() {
        return IArchimateImages.ImageFactory.getImage(IArchimateImages.ICON_ASSESSMENT_FILLED_16);
    }

    @Override
    public ImageDescriptor getImageDescriptor() {
        return IArchimateImages.ImageFactory.getImageDescriptor(IArchimateImages.ICON_ASSESSMENT_FILLED_16);
    }
