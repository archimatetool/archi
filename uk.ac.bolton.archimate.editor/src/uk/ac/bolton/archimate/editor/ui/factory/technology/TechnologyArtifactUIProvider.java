...
public class TechnologyArtifactUIProvider extends AbstractTechnologyUIProvider {
    ...
    public Image getImage() {
        return IArchimateImages.ImageFactory.getImage(IArchimateImages.ICON_TECHNOLOGY_ARTIFACT_16);
    }

    @Override
    public ImageDescriptor getImageDescriptor() {
        return IArchimateImages.ImageFactory.getImageDescriptor(IArchimateImages.ICON_TECHNOLOGY_ARTIFACT_16);
    }
}
