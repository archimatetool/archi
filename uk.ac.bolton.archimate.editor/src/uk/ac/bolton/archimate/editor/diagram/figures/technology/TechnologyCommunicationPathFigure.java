 ...
 */
public class TechnologyCommunicationPathFigure extends AbstractRectangleFigure {
    ...
    protected Image getImage() {
        return IArchimateImages.ImageFactory.getImage(IArchimateImages.ICON_COMMUNICATION_PATH_16);
    }
}
