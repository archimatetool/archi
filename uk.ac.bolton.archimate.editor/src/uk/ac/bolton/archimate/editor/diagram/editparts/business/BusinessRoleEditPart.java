...
import uk.ac.bolton.archimate.editor.diagram.figures.business.BusinessRoleFigure;
 ...
 */
public class BusinessRoleEditPart
extends AbstractArchimateEditableTextFlowEditPart {            
    
    @Override
    protected IFigure createFigure() {
        return new BusinessRoleFigure(getModel());
    }
