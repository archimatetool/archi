...
public class UserPropertiesSection extends AbstractArchimatePropertySection {
    ...
    private void createTableControl(Composite parent) {
        ...
        fActionRemoveProperty = new Action("Remove") {
            ...
            public void run() {
            	if(isAlive()) {
            		CompoundCommand compoundCmd = new EObjectNonNotifyingCompoundCommand(fPropertiesElement, "Remove Properties");
    ...
    private class KeyEditingSupport extends EditingSupport {
		...
		protected void setValue(Object element, Object value) {
			if(isAlive()) {
				getCommandStack().execute(new EObjectFeatureCommand("Set Key", (IProperty)element,
    ...
    private class ValueEditingSupport extends EditingSupport {
		...
		protected void setValue(Object element, Object value) {
			if(isAlive()) {
				getCommandStack().execute(new EObjectFeatureCommand("Set Value", (IProperty)element,
