...
public class Messages extends NLS {
    ...
    private static final String BUNDLE_NAME = "uk.ac.bolton.archimate.canvas.messages"; //$NON-NLS-1$
    ...
    public static String CanvasEditorPalette_3;

    public static String CanvasEditorPalette_4;

    public static String CanvasEditorPalette_5;

    public static String CanvasEditorPalette_6;

    public static String CanvasEditorPalette_7;

    public static String CanvasEditorPalette_8;
